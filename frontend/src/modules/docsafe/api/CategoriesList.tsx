...
export const CategoriesList: React.FC = () => {
  ...
  const handleToggleActive = async (id: string) => {
    ...
    await updateCategory(id, cat.name, cat.description || '', !cat.isActive);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    let success = false;
    if (editingCatId) {
      success = await updateCategory(editingCatId, name, description, isActive);
    } else {
      success = await createCategory(name, description, isActive);
    }
